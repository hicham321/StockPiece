...
public class InterfaceSuppLot extends JFrame{
    private JLabel suppLabel= new JLabel("هل انت متاكد من حذف هذا ");
	private JButton ok= new JButton("موافقة");
	private JButton annule= new JButton("الغاء");

	public InterfaceSuppLot(){
		setResizable(true);
		setSize(400,200); 
	...
	public void addSuppLotInterfaceListener (ActionListener listner){
